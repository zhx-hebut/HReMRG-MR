...
__C.DATA_LOADER.TRAIN_ATT_FEATS = 'data/mimic_att/'

__C.DATA_LOADER.VAL_GV_FEAT = ''

__C.DATA_LOADER.VAL_ATT_FEATS = 'data/mimic_att/'

__C.DATA_LOADER.TEST_GV_FEAT = ''

__C.DATA_LOADER.TEST_ATT_FEATS = 'data/mimic_att/'

__C.DATA_LOADER.TRAIN_ID = 'mimic_train_image_id.txt'

__C.DATA_LOADER.VAL_ID = 'mimic_val_image_id.txt'

__C.DATA_LOADER.TEST_ID = 'mimic_test_image_id.txt'

__C.DATA_LOADER.INPUT_SEQ_PATH = 'mimic_train_input.pkl'

__C.DATA_LOADER.TARGET_SEQ_PATH = 'mimic_train_target.pkl'
...
__C.MODEL.TYPE = 'XLAN'               # 'UpDown', 'XLAN', 'XTransformer'

__C.MODEL.SEQ_LEN = 184                  # include <EOS>/<BOS> 17

__C.MODEL.VOCAB_SIZE = 2991            #9487      # exclude <EOS>/<BOS>
...
__C.SCORER.GT_PATH = 'mimic_train_gts.pkl'

__C.SCORER.CIDER_CACHED = 'mimic_train_cider.pkl'
...
__C.INFERENCE.VOCAB = 'mimic_vocabulary.txt'
...
__C.INFERENCE.VAL_ANNFILE = 'mimic_captions_val.json'

__C.INFERENCE.TEST_ANNFILE = 'mimic_captions_test.json'
